...
export const AE_INVENTORY_ACTION_ROOT_SELECTOR = [
    ".item-name",
    ".item-image",
    ".item-action",
    ".rollable",
...
const AE_INVENTORY_PRIMARY_TRIGGER_SELECTOR = [
    ".item-name",
    ".item-image",
    ".item-action",
    ".rollable",
...
export function getInventoryActionRoot(element)
{
    ...
    return element.closest(AE_INVENTORY_ACTION_ROOT_SELECTOR);
}
...
export function resolveInventoryActivationTarget(element)
{
    ...
    const activationTarget = resolvedTarget.matches(AE_INVENTORY_PRIMARY_TRIGGER_SELECTOR)
